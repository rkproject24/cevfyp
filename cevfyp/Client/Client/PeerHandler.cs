            ...
            try
            {
                while (!joined)
                {
                    ...
                    if (reconnectUse)
                    {
                        ...
                        //    {
                        //        conNode = joinPeers[k];
                        //        ((LoggerFrm)clientFrm.downloadFrm).rtbdownload.BeginInvoke(new UpdateTextCallback(clientFrm.UpdateRtbDownload), new object[] { "conNode=FR T[" + (i - 1) + "] ID:" + joinPeers[k].Id + "\n" });
                        //        fastConnect[k] = false;
                        //        break;
                        //    }
                        //}
